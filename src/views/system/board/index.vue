<template>
    <div>
        <!-- 发表留言 -->
        <el-form :model="newMessage" ref="messageForm" class="message-form">
        ...
        <el-card class="message-list">
            <div v-for="message in messages" :key="message.id" class="message-item">
                ...
                <!-- 回复留言的表单 -->
                <el-form ref="replyForm" :model="replyForm" :rules="replyFormRules" class="reply-form" v-if="showReplyForm">

                    <el-form-item label="回复内容" prop="replyContent">
                        <el-input type="textarea" v-model="replyForm.replyContent" placeholder="请输入回复内容"></el-input>
                    </el-form-item>
                    <el-form-item>
