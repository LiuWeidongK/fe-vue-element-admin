<template>
    <div>
        ...
        <el-table :data="destinations" border>
            ...
            <el-table-column prop="destination" label="毕业去向"></el-table-column>
            <el-table-column prop="city" label="去哪个城市"></el-table-column>
            <el-table-column prop="reason" label="去该城市的原因"></el-table-column>
        </el-table>
    </div>
</template>
